 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__2ECEF7A9_45E3BE_4548AC_458F33_45A5B464D4113E;
...
public class TrafficViolationResource {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/InputSet")), description = "DMN input")
    @io.swagger.v3.oas.annotations.responses.ApiResponse(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/OutputSet")), description = "DMN output")
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_2ECEF7A9-E3BE-48AC-8F33-A5B464D4113E", "TrafficViolation");
        ...
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_2ECEF7A9-E3BE-48AC-8F33-A5B464D4113E", "TrafficViolation", decisionResult);
