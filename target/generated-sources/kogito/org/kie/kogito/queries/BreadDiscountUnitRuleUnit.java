...
public class BreadDiscountUnitRuleUnit extends AbstractRuleUnit<BreadDiscountUnit> {

    private static final InternalKnowledgeBase kb = createKnowledgeBase();

    @javax.inject.Inject()
    public BreadDiscountUnitRuleUnit(org.kie.kogito.Application app) {
        super(BreadDiscountUnit.class.getCanonicalName(), app);
    }

    public org.kie.kogito.queries.BreadDiscountUnitRuleUnitInstance internalCreateInstance(BreadDiscountUnit value) {
        return new org.kie.kogito.queries.BreadDiscountUnitRuleUnitInstance(this, value, createLegacySession());
    }
    ...
    private static InternalKnowledgeBase createKnowledgeBase() {
        ...
        InternalKnowledgeBase kb = org.drools.modelcompiler.builder.KieBaseBuilder.createKieBaseFromModel(new org.kie.kogito.queries.RulesF894883E1030542FEFCE9860F835B9B7_BreadDiscountUnit(), ruleBaseConfig);
        return kb;
    }
}
